...
╚══════════════════════════════╝"
    ...
    MsSpoti         = "The Microsoft Store version of Spotify (thats something bad)"
    MsSpoti2        = "Uninstall Spotify Microsoft Store edition [Y/N]"
    MsSpoti3        = "Uninstalling Spotify MS..."
    ...
    NewV2           = "Your Spotify {0} version hasn't been correctly recognised, currently it's a stable {1} version"
    NewV3           = "Do you want to continue with {0} version (errors very likely)(that means you should say No) ? [Y/N]"
    Recom           = "Do you want to install the recommended {0} version ? [Y/N]"
    DelNew          = "Uninstalling Spotify..."
    ...
    NoRestore       = "Spotify has already been installed, but files to recover xpui.js.bak and xpui.css.bak not found. `nPlease uninstall Spotify client and run Install.bat again"
    ExpSpotify      = "Experimental features operated by Spotify"
    ExpStandart     = "Experimental features of Spotify are not included"
    NoRestore2      = "Spotify has already been installed, xpui.bak not found. `nPlease uninstall Spotify client and run Install.bat again"
